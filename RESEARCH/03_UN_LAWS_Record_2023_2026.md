# UN LAWS RECORD — 2023–2026

**Purpose:** factual backbone for Brazil's research before lobbying. This file records the real UN/CCW process only. It is **not** a GSL, MOD plan, bloc plan, or resolution draft.

## 1. General Assembly trajectory
...
- A/RES/79/62: https://digitallibrary.un.org/record/4068497
- A/RES/80/57: https://digitallibrary.un.org/record/4094456

## 2. 2025 vote — exact matrix-relevant classification

The official UN voting record for A/RES/80/57 gives **164 YES, 6 NO, 7 abstentions, 16 non-voting**.

**NO:** Belarus, Burundi, Democratic People's Republic of Korea, Israel, Russian Federation, United States.

**ABSTAIN:** Argentina, China, Iran, Nicaragua, Poland, Saudi Arabia, Türkiye.
...
- calls on CCW High Contracting Parties to work toward completing the elements for an instrument, with a view to future negotiations;
- stresses the importance of the role of humans in the use of force, responsibility and accountability, and compliance with international law;
...
**Working rule:** use votes to identify leads; use official statements and primary documents to determine actual positions.
